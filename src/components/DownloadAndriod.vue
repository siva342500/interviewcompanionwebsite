    ...
    <div class="download-page">
      ...
      <div class="content-section">
        ...
        <p>
          ...
          Android app to access all features, including interview support,
          training, and more, at your fingertips.
        </p>
        <ul>
        ...
        <form @submit.prevent="sendLink">
          ...
          <button class="btn bg-black mt-3" type="submit">Send Link</button>
        </form>
      ...
      if (this.phoneNumber) {
        try {
          ...
          const response = await axios.post(
            "https://api.interview-companion.com/api/send-link",
            data
          );
